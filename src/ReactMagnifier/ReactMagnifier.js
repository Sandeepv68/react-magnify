...
var ReactMagnifier = /** @class */ (function (_super) {
    ...
    ReactMagnifier.prototype.render = function () {
        return (React.createElement("div", { className: "react-magnifier-image-container " + this.props.customContainerStyles, ref: this.imageContainer },
            React.createElement("img", { ref: this.magnifiableImage, className: this.props.customImgStyles, src: this.props.imageUrl, width: this.props.imageWidth, height: this.props.imageHeight, alt: this.props.imageAltText })));
    };
    /**
     * Set default props
     */
